...
|---|---|---|---|---|
| EPUB | 3.3 W3C Recommendation | OCF ZIP, exactly one SPD rootfile, `container.xml` processing links, package document, manifest, spine, navigation, resource URLs | Profiled with offline/security/inventory/discovery restrictions | SPD-BASE-001–006, SPD-DISC-001–003, SPD-RES-001–006 |
| HTML | Living Standard as referenced by EPUB 3.3 | XHTML serialization and native semantics | Profiled | SPD-SEM-001–013 |
| XML | 1.0 Fifth Edition | Well-formed XHTML/XML IDs | Unchanged | SPD-SEM-002, SPD-ID-005–010 |
| CSS | Snapshot/reference set inherited through EPUB 3.3 | Author styling and paged media | Profiled | SPD-SEC-005, SPD-I18N-002 |
| MathML | Core/MathML 3 as applicable through EPUB 3.3 | Semantic mathematics | Profiled | SPD-SEM-009 |
| SVG | 2 as applicable through EPUB 3.3 | Static vector graphics | Security-profiled | SPD-SEC-007 |
| Unicode | Current supported version, declared by processor | Scalar values and character encoding | Profiled; UAX #9 logical order is normative behavior | SPD-I18N-001–006, SPD-MAP-008–009 |
