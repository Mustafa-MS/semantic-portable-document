...
**File extension:** Not assigned in Format 0.1 RC1

**Media type:** No SPD-specific media type assigned in Format 0.1 RC1
...
The selector type expands to the stable IRI `urn:uuid:95d3b3f6-45bb-50fd-9aa5-8bba8186649f`. Its compact extension terms are mapped by the inline context defined in the annotation profile and identifier registry.
...
PDF/A-4 is the Format 0.1 reference archival fixed-rendition target.
...
|---|---|---|
| `urn:uuid:0f55d1fb-e1b0-50bb-8a92-53d09c9aa7fc` | `application/json` | document/revision/capability descriptor |
| `urn:uuid:08f2982f-d258-5482-abdc-cd6e2b86d990` | `application/json` | normative inventory |
| `urn:uuid:ec3f5340-bab9-5d57-8c81-77e08906aa4c` | `application/json` | EDITABLE/SEALED state descriptor |
...
| Decision | Format sections | Normative result |
|---|---|---|
